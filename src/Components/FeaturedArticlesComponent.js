            ...
            <div className={styles.featured_Articles_Left} > {
                ...
                bollywood.map((article, index) => {
                    if (index >= bollywood.length - 1) {
                        return ( 
                        <div key = { index } className = { styles.featured_Articles_Box_Big }
                        style = {
                            {
            ...
            technology.map((article, index) => {
                if (index >= technology.length - 1) {
                    return ( <
                        ...
                        div className = { styles.Box_Category_Date } >
                        <
                        span > { technology[technology.length - 1].CategoryName } <
                        /span> <
                        span > / </span >
                        <
                        span > { technology[technology.length - 1].PublishedDate } <
                        /span> <
                        /div> <
                        /div>
                    );
